...
$route['signin'] = "site/user/signup_form";
...
$route['contact-support'] = "site/user_settings/contact_support";
$route['my-offers'] = "site/user_settings/my_offers";
$route['save_contact_support'] = "site/user_settings/save_contact_support";
...
$route['placeOrder'] = "site/cart/placeOrder";
...
$route['products/ajax/(:any)'] = "site/product/display_product_detail_ajax/$1"; 
...
$route['product-setup'] = "site/shop/draft_product_list";
$route['add-product/(:any)'] = "site/shop/product_setup/$1";
...
$route['search/(:any)'] = "site/product/search_product/$1/$2";
...
$route['csv-upload'] = "site/product_import/upload_csv_form";
...
/*****************people routes start*******************/
$route['myLikes'] = "site/user/mylikes";
...
$route['user-email-settings'] = "site/user_settings/user_email_setting";
...
$route['shop/promotions'] = "site/shop/promotions";
$route['shop/promotions/(:any)'] = "site/shop/promotions/$1";
$route['shop/create_promotion'] = "site/shop/create_promotion";
$route['shop/create_promotion/(:any)/(:any)'] = "site/shop/create_promotion/$1/$2";
...
$route['shops/(:any)/bizinfo']="site/shop/load_shop_bizinfo";
...
$route['shops/shop-orders']="site/shop/display_shop_orders";
...
$route['merchant-home'] = "site/shop/merchant_home";
$route['merchant-billing'] = "site/seller/billing";
$route['merchant-plan']    = "site/seller/plans";
$route['merchant-payments'] = "site/seller/payments";
$route['merchant-penalty'] = "site/seller/penaltys";
$route['merchant-shipstation'] =  "site/shop/shipstation_help";
$route['merchant-support'] = "site/seller/merchant_support";
$route['product-import-history'] = "site/seller/product_import_history";
$route['shop/(:any)'] = "site/shop/load_shop_open/$1";
