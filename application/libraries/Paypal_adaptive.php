...
*/
//error_reporting(-1);
//require_once('paypal-sample.php');
require_once('Paypal_pro.php');



//$this->ci =& get_instance();
//$this->ci->config->load('paypal-sample');

//echo $this->ci->config->item('ApplicationID');die;
//echo  "<pre>";print_r($this->ci->config);die;



$DataArray = $this->ci->config;
//echo $config['ApplicationID'];die;
...
class PayPal_Adaptive extends PayPal_Pro
{
	...
	//	echo  "<pre>";print_r($this->ci->config);//die;
		...
		//echo $this->ci->config->item('APISignature');die;
		
		$conig_vals = $this->ci->config;
		$DataArray = array();
		foreach($conig_vals->config as $configitemskeyrs=>$configitemsvals)
		{
			$DataArray[$configitemskeyrs] = $configitemsvals;
		}

	
	//echo "<pre>";print_R($DataArray);die;
//echo $DataArray['ApplicationID'];die;
	...
	//echo "<pre>";print_r($ClientDetailsFields);die;
