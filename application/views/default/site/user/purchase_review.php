...
<div class="tab-head ">
			<nav class="nav-sidebar">
				<ul class="nav tabs ">
					  ...
					  <li class="active" style="padding-left:30px; padding-right:30px;">
                      	<a href="purchase-review" onclick="location.reload();" data-toggle="tab"><h4>New Orders</h4></a>
                      </li> 
					  <li class="" style="padding-left:30px; padding-right:30px;">
                      	<a href="javascript:void(0);" onclick="show_shipped();" data-toggle="tab"><h4>Shipped</h4></a></li>  
                      <li class="" style="padding-left:30px; padding-right:30px;">
                      	<a href="javascript:void(0);" onclick="show_completed();" data-toggle="tab"><h4>Completed</h4></a>
                        </li> 
                      <li class="" style="padding-left:30px; padding-right:30px;">
...
<div id="order_popup" style="display:none">
  <div class="head1">Order Details<span class="close-popup"><i class="fa fa-times fa-2x"></i></span></div>
...
function show_order( order_id ) {
	...
	$.ajax({
		...
		success: function(result) {
			...
			$('#order_info').html('');
			$('.total_row').remove();
			var order_date = result.order.date_added;
			var odate = order_date.split(" ");
			var odate1 = odate[0].split("-");
             html += '<div class="col-md-5 text-right" >Order #: </div><div class="col-md-6" >' + result.order.order_id + '</div>';
             html += '<div class="col-md-5 text-right">Order Date: </div><div class="col-md-6">' + odate1[1] + "-" + odate1[2] + "-" + odate1[0] + '</div>';
