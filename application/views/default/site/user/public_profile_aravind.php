...
//echo "<pre>";print_r($PublicProfile->row());echo "</pre>";
?>
...
.ssa-form input[type='text'],.ssa-form input[type='number'],.ssa-form textarea{
    width: 100%!important;
    border-radius: 0;
...
.ssa-form .cc-expiration-month,.ssa-form .cc-expiration-year,.ssa-form .ssa-state,.ssa-form select
{
    border: 1px solid #4c4a4e;
    color: #4c4a4e;
    background: #fff url('../images/select_down.svg') no-repeat right 5px top 50%;
...
<div id="profile_div">
	<section class="container">
    	...
    	<div class="main">
            ...
            <h3> <?php if($this->lang->line('user_ur_pub_prof') != '') { echo stripslashes($this->lang->line('user_ur_pub_prof')); } else echo 'Your Public Profile'; ?></h3>
          ...
          <form class="ssa-form" action="site/user/update_public_profile" method="post" enctype="multipart/form-data" id="profile_form" name="profile_form ">
...
?>
            <div class="pass-right">
        	        ...
        	        <input name="include_profile[]" type="checkbox" <?php  if(in_array('Shop',$include_arr)) echo "checked"; ?> value="Shop" class="chkb"  style="float:left;cursor:pointer !important;" id="Shop" />
                   ...
                   <input name="include_profile[]"  <?php  if(in_array('Favorite_items',$include_arr)) echo "checked"; ?>  type="checkbox" class="chkb" value="Favorite_items" id="Favorite_items"  style="float:left;cursor:pointer !important;" />
                    ...
                    <div class="clear"></div>
                     ...
                     <input name="include_profile[]" type="checkbox"  <?php  if(in_array('Favorite_shops',$include_arr)) echo "checked"; ?>  class="chkb" value="Favorite_shops" id="Favorite_shops"  style="float:left;cursor:pointer !important;" />
                    ...
                    <input name="include_profile[]"  <?php  if(in_array('Teams',$include_arr)) echo "checked"; ?> type="checkbox" class="chkb" value="Teams" id="Teams"  style="float:left;cursor:pointer !important;" />
...
<div class="bottombutton">
          	<input type="submit" class="btn btn-primary" value="<?php if($this->lang->line('user_save_changes') != '') { echo stripslashes($this->lang->line('user_save_changes')); } else echo 'Save Changes'; ?>" style=" margin-left:10px; margin-top:1px;" id="profile_submit" onclick="return date_validation();"/>
</div>
