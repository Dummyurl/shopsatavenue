                    ...
                    <ul id="panel" class="add_steps" style="background:none; box-shadow:none;">
                        ...
                        <?php 
                            ...
                            <li <?php if (in_array('conversations', $urlArr) || in_array('conversations', $urlArr)){ echo 'class="side_active"';  }?>>
                                ...
                                <a class="contact-popup2" href="javascript:void(0);"><?php echo shopsy_lg('lg_conversations','Conversation');?></a>
                            ...
                            <li <?php if (in_array('conversations', $urlArr) || in_array('conversations', $urlArr)){ echo 'class="side_active"';  }?>>
                                ...
                                <a href="people/<?php echo stripslashes($userProfileDetails[0]['user_name']);?>/conversations"><?php echo shopsy_lg('lg_conversations','Conversation');?></a></a>
