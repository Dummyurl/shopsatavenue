                            ...
                            <div class="small-12 columns">
                                <div class="saa-checkout-summary show-msrp" data-row-type="price">
                                    <div id="cart-totalMsrp" class="msrp-column right-side">
                                        <span class="symbol">$</span><span class="dollars"><?php echo number_format($total_msrp,2);?></span>
                                    </div>
                             ...
                             <div class="clearfix"></div>   </div>
                                ...
                                <div class="saa-checkout-summary order-summary-subtotal" data-row-type="subtotalWithDiscounts">
                                    <div id="cart-subtotalWithDiscounts" class="msrp-column right-side">
                                        <span class="symbol">$</span><span class="dollars"><?php echo number_format($sub_total,2); ?></span><!--<span class="period">.</span>
                    ...
                    <div class="row item-summary-info">
                      ...
                      ?>
                           ...
                           <div class="col-md-12 details-trigger">
                            ...
                            <div aria-expanded="false" id="ssaitem-details-<?php echo ($i+1);?>" class=" collapse col-xs-12 columns sellable-price" data-toggler=".expanded">
                                <div class="ssa-price-row show-msrp">
                                    ...
                                    <div class="detail floatright50"> <span class="symbol">$</span><span class="dollars"><?php echo number_format($cart[$i]->msrp*$cart[$i]->quantity, 2);?></span><!--<span class="period">.</span><span class="cents">99</span>-->
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                                ...
                                <div class="ssa-price-row" data-row-type="savings">
                        ...
                        <div class="row clearfix ssa-price-row sellable-total">
                            ...
                            <div class="col-xs-6 detail floatright50">
                                <strong class="float-right"><span style="font-size:large; font-weight:800;">$<?php echo number_format( $item_total_amount + $shipping_total, 2) ;?> </span>
