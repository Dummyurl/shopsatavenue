    ...
    <div class="container" style="margin:0">
      <div class="cart_items">
        ...
        <div class="cart-list chept2" style="padding: 100px 20px;">
		  <div>Thank you for your order from Shops@Avenue!. Your payment is declined. Your order will be shipped after you make payment.<br />
          Your order number is #<?php echo $order_id; ?>.</div>
          <div class="clear"></div>
		</div>                  
      </div>
    </div>
