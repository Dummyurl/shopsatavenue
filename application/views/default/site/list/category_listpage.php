			...
			<div class="main">
				...
				<nav id="nav-main">
					...
					<li>
						...
						<a href="search/all/<?php echo $this->uri->segment(2).'/'; echo $subCat['id'].'-'.$subCat['seourl'];?>"><?php echo ucfirst($subCat['cat_name']);?></a>
    ...
    <div id="container" class="clearfix">
     ...
     <li class="box row<?php echo $s; ?>">
		<div class="banner-out">
            <div class="banner-in">
				 <a href="search/all/<?php echo $this->uri->segment(2).'/'; echo $subCatList['id'].'-'.$subCatList['seourl']; ?>" >
