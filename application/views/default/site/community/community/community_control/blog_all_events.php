...
<section class="container">
        ...
        <ul class="bread_crumbs">
            ...
            <li> <a href="settings/my-account/<?php echo $this->session->userdata['shopsy_session_user_name']; ?>" class="a_links"><?php if($this->lang->line('comm_account') != '') { echo stripslashes($this->lang->line('comm_account')); } else echo "Your Account"; ?></a></li>
             <span>&rsaquo;</span>
            <li> <?php if($this->lang->line('comm_events') != '') { echo stripslashes($this->lang->line('comm_events')); } else echo "Events"; ?></li>
        </ul>
     <div class="clear"></div>
     <div class="hole_content">
      <div class="heading"><?php if($this->lang->line('comm_events') != '') { echo stripslashes($this->lang->line('comm_events')); } else echo "Events"; ?></div>
        	<?php  $this->load->view('site/community/community/community_control/blog_leftside.php'); ?>
             <form name="seekerActionForm" id="seekerActionForm" method="post" enctype="multipart/form-data" action="site/community/eventActiveInactiveDeleteFunction" >	
            ...
            <div class="right_split">
                    ...
                    <a class="btn btn-success see_more" style="float:left" href="add-event" ><i class="icon-ok"></i><?php if($this->lang->line('com_addevent') != '') { echo stripslashes($this->lang->line('com_addevent')); } else echo "Add Event"; ?> </a>
 ...
 <td><input type="checkbox" class="caseSeeker" name="seekerCheckbox[]" value="<?php echo $details['id']; ?>" /></td>
   <td><a href="events"><?php echo stripslashes($details['eventTitle']);?></a></td>
   <td><?php echo stripslashes($details['eventType']);?></td>
  <!-- <td><?php echo stripslashes($details['comment_date']);?></td>-->
   <td><?php echo stripslashes($details['eventDate']). " ".stripslashes($details['eventstartTime']) ;?></td>
   <td><div class="edit">
   <?php if($details['status'] == 'Active') { ?>
        <a  href="site/community/update_events/<?php echo stripslashes($details['id']);?>/<?php echo stripslashes($details['status']);?>" onclick="return changeStatusCommon('<?php echo $details['status']; ?>');"><img src="images/active.png" title="<?php echo ucfirst($details['status']); ?>"  /></a>
   <?php } else { ?>
		 <a  href="site/community/update_events/<?php echo stripslashes($details['id']);?>/<?php echo stripslashes($details['status']);?>" onclick="return changeStatusCommon('<?php echo $details['status']; ?>');"><img src="images/inactive.png" title="<?php echo ucfirst($details['status']); ?>"  /></a>
    <?php } ?>

    <a href="edit-event/<?php echo stripslashes($details['id']);?>" style="padding-left:0px;"><img src="images/edit.png" title="Edit"   /></a>
   <a href="site/community/delete_event_v/<?php echo stripslashes($details['id']);?>" onclick="return changeStatusCommon('delete');"><img src="images/delete.png" title="Delete"  /></a>
