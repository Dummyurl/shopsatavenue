                    	...
                    	<div style="float:left; width:100%;">
                        	<div class="row_left">
                            	<div class="panel_inner">
                                    ...
                                    <a href="teams"><?php if($this->lang->line('com_joinateam') != '') { echo stripslashes($this->lang->line('com_joinateam')); } else echo "Join a team"; ?>,</a>  <a href="events"><?php echo $this->config->item('email_title'); ?> <?php if($this->lang->line('com_eventinarea') != '') { echo stripslashes($this->lang->line('com_eventinarea')); } else echo "attend an event in your area"; ?></a>. 
