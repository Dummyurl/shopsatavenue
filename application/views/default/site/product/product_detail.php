        ...
        <div class="box cf">
          ...
          <?php
            ...
            $imgCount = count($imageArr);
                    ...
                    <span class="product_img_slider"><img id="product_img_slider"  src="<?php echo 'images/product/'.$preview_item_detail[0]['id'].'/'.$imageArr[0]; ?>"  /></span>
      <ul id="product_img_slider_carusel" class="elastislide-list">
                    ...
                    for($i=0; $i < $imgCount; $i++) { 
                                    ?>
                                         ...
                                         <li><a href="#"><img src="<?php echo 'images/product/'.$preview_item_detail[0]['id'].'/'.$imageArr[$i]; ?>" data-largeimg="<?php echo 'images/product/'.$preview_item_detail[0]['id'].'/'.$imageArr[$i]; ?>" /></a></li>
                  <?php } ?> 
                ...
                <?php if ( $preview_item_detail[0]['variable_product'] ) { 
                    ...
                    <p class="add-cart" style="margin-top:10px;" >
                      <button type="button" onclick="return ajax_add_cart_new();" class="button">
                                        ...
                                        <p class="add-cart" style="margin-top:10px;">
                      <button type="button" onclick="return  addFavourite('<?php echo $preview_item_detail[0]['id'];?>');" class="button"><i class="fa fa-heart" style="padding-right:10px;"></i>Add to Wishlist</button>
                    </p>
                  </div>
            <div class="widget">
                      ...
                      $imageArr = explode(',',$related_items[$i]['image']); ?>
                                <div class="col-md-4 col-sm-6">
                                    <div class="related-item-table">
                                        ...
                                        <a href="javascript:;" onclick="<?php echo $loginCheck != '' ? 'addFavoriteItem(this)' : "$('#login-popup').modal('show')"; ?>" data-id="<?php echo base64_encode($related_items[$i]['id']);?>" class="inline-heart is-unloved">
