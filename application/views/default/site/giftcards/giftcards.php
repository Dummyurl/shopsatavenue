    ...
    <div class="giftcard-shop community_right">
		...
		<div class="col-lg-12 giftcard-shop-main">
                                ...
                                <?php if($giftCard->image!=""){ ?>  
                                    ...
                                    <ul>
                                       ...
                                       <?php  $giftImage=@explode(',',rtrim($giftcardDetails[0]->image,','));                                     
                                        ...
                                        <?php } } } foreach($giftImage as $img){ if($img != ""){ if($giftCard->image!=$img){?>
			...
			<div class="col-lg-6 giftcard-shop-right">
				 ...
				 <div class="addresbar">
                            ...
                            <input type="hidden" name="sender_mail" id="sender_mail" value="<?php if($giftCard->sender_mail==''){echo $this->session->userdata('shopsy_session_user_email');}else{echo $giftCard->sender_mail;} ?>" />
                            ...
                            <div class="first_name">
                              ...
                              <input type="text" maxlength="25" value="<?php echo $giftCard->recipient_name; ?>" name="recipient_name" id="recipient_name" placeholder="<?php if($this->lang->line('gc_name') != '') { echo stripslashes($this->lang->line('gc_name')); } else echo "Recipient's name"; ?>">

                              <span class="error recipient_nameErr"></span>
                            ...
                            <div class="last_name">
                              ...
                              <input type="text" maxlength="25" value="<?php if($giftCard->sender_name==''){echo $this->session->userdata('shopsy_session_full_name');}else{echo $giftCard->sender_name;} ?>" name="sender_name" id="sender_name" placeholder="<?php if($this->lang->line('gc_yourname') != '') { echo stripslashes($this->lang->line('gc_yourname')); } else echo "Your name"; ?>">

                              <span class="error" id="sender_nameErr"></span>

                            </div>

                            <div class="text__area">

                              <label> <?php if($this->lang->line('gift_addnote') != '') { echo stripslashes($this->lang->line('gift_addnote')); } else echo "Add a note (optional)"; ?><span style="float:right" id="maxtext_notify"><?php echo 500 - strlen($giftCard->description) ?></span>  </label>

                              <textarea rows="6" placeholder="<?php if($this->lang->line('gc_personalnote') != '') { echo stripslashes($this->lang->line('gc_personalnote')); } else echo "Add a personal note or suggest some unique items"; ?>!" name="description" id="description" maxlength="500"><?php echo $giftCard->description; ?></textarea>

                        	</div>

                    	</div>
						
						 <div class="curency_addres">

                    <div class="currency_head"><span><?php if($this->lang->line('gift_cardadd') != '') { echo stripslashes($this->lang->line('gift_cardadd')); } else echo "Address the card"; ?></span></div>

                    <div class="addresbar">

                      <div class="first_name">

                        <label class="to_mail"> <?php if($this->lang->line('gift_emailadd') != '') { echo stripslashes($this->lang->line('gift_emailadd')); } else echo "Recipient's email address"; ?></label>

                        <input type="text" placeholder="<?php if($this->lang->line('giftcard_email') != '') { echo stripslashes($this->lang->line('giftcard_email')); } else echo "Recipient's email"; ?>" name="recipient_mail" id="recipient_mail" value="<?php echo $giftCard->recipient_mail; ?>" >

                        <span class="error" id="recipient_email"></span>

                      </div>

                      <div class="last_name">

                        <label class="to_rmail"> <?php if($this->lang->line('gift_reemailadd') != '') { echo stripslashes($this->lang->line('gift_reemailadd')); } else echo "Re-enter recipient's email address"; ?></label>

                        <input type="text" placeholder="<?php if($this->lang->line('giftcard_email') != '') { echo stripslashes($this->lang->line('giftcard_email')); } else echo "Recipient's email"; ?>" id="re_recipient_mail" value="<?php echo $giftCard->recipient_mail; ?>" >
                    ...
                    <div class="dropdown-box"> 
                    	...
                    	<span class="arrow9"></span>
                         ...
                         <?php foreach($currencyList->result() as $cList){?>
                            ...
                            <li  <?php if($cList->currency_code == $currencyType){echo 'class="selected"';}?> id="<?php echo $cList->currency_code.'-'.$cList->currency_symbol.'-'.$cList->currency_value;?>" onclick="return changeCurrency(this);">

                              <label title="<?php echo $cList->currency_code;?>" > <span class=""><?php echo $cList->currency_symbol;?></span> <span class=""><?php echo $cList->currency_code;?></span> </label> 
                  ...
                  <ul class="curency_button">
					...
					foreach($giftPrice as $Price){
						//echo $currencyValue;
						//echo number_format($Price * $currencyValue,2);
					?>

                    <li class="test <?php if(($giftCard->price_value * $currencyValue) == ($Price*$currencyValue)){ echo 'selected';}?>" >

                      <label id="<?php echo $Price * $currencyValue;?>" class="priceList">

                          <span class="dolar-symbol"><?php echo $currencySymbol; ?></span> 
					
                          <span class="dolar-value"  data-orgprice="<?php echo $Price * $currencyValue;?>"><?php echo $Price * $currencyValue;?></span> 
                    ...
                    <input type="hidden" name="price_value" id="price_value" value="<?php echo $giftCard->price_value; ?>" /> 

                  </ul>

                  <span class="error priceErr" id="priceErr"></span>

                 

                  <div class="gn_bg">

                    <button  class="cart_button" type="submit" <?php if ($loginCheck==''){echo 'require_login="true"';}?> onclick="return add_gift_card();"> <span class="text-cart"><?php if($this->lang->line('shop_addtocart') != '') { echo stripslashes($this->lang->line('shop_addtocart')); } else echo "Add to Cart"; ?></span> <span class="spinner-cart"></span> </button>
		...
		<div class="col-lg-12 giftcard-shop-main">
					...
					<div class="foot_text"> 
						...
						<span><?php if($this->lang->line('gift_giftcard') != '') { echo stripslashes($this->lang->line('gift_giftcard')); } else echo "View our Gift Card"; ?> <a href="pages/terms-conditions"><?php if($this->lang->line('user_touse') != '') { echo stripslashes($this->lang->line('user_touse')); } else echo "Terms of Use"; ?>.</a> </span>
      ...
      <div class="tab-content">
        ...
        <div id="TabbedPanels1" class="TabbedPanels">
          ...
          <!--<ul class="TabbedPanelsTabGroup newtb">
            ...
            <?php /*?>  <div class="giftshop-main">

                <div style="margin:30px 0 0 0" class="gift_card_container">
