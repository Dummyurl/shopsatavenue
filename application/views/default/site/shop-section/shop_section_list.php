				...
				<div class="add_listimg shop-detail shopview_info">
					...
					<div class="shopview_info profile-info-img">
						...
						<div class="shop_view_text">
							<a style="font-size:14px; font-weight:bold; line-height:24px; float:left;  text-decoration:none;" href="shop-section/<?php echo stripslashes($get_seller_details['seller_businessname']); ?>"><?php echo stripslashes($get_seller_details['seller_businessname']); ?></a>
					...
					<form action="spam-report" name="span-form" method="post" onsubmit="return validate_spamreport();">
						<div class="conversation" style="width: 86%;">
							<div class="conversation_container">
								...
								<a target="_blank" href="pages/intellectual-property-policy"><?php if($this->lang->line('shopsec_property') != '') { echo stripslashes($this->lang->line('shopsec_property')); } else { echo 'This is my intellectual property'; } ?></a><br />
