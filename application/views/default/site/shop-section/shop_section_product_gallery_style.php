	...
	<div id="tiles">
		...
		?>
            ...
            <div class="brick">   
               ...
               <a href="products/<?php echo $shop_section_products['seourl']?>">   <img src="<?php echo 'images/product/'.$shop_section_products['id'].'/thumb/'.$img; ?>" alt="<?php echo stripslashes($shop_section_products['product_name']); ?>" title="<?php echo stripslashes($shop_section_products['product_name']); ?>" /></a></div>
