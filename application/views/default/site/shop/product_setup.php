...
<div class="container" >
	<form  id="form-products" name="form-products" method="post" action="" novalidate="novalidate">
        <div class="row">
           <div class="col-md-12">
            <div class="col-md-4"><h4>Total Draft Products (<?php echo $total_products; ?>)</h4></div>
            <div class="col-md-4"><a href="site/shop/product_setup" title="Add Product"><h4><i class="fa fa-plus-circle"></i>Add New Product</h4></a></div>
            <div class="col-md-4">
           ...
           <div class="col-md-12">
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo number_format($products[$i]['price'],2);  ?></td>
