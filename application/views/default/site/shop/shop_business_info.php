...
<div class="container" >
	...
	<div class="row">
    	...
    	<div class="col-md-6">
			...
			<div class="field-wrapper">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3 col-xs-12 label-wrap">
                    	<label aria-required="true" for="transaction_billing_region">State</label>
                    <select  class="ss-select-small"  name="ship_state"  >
                        <?php echo $states; ?>
                    </select>
                    </div>
                    <div class="col-md-4 col-xs-12 label-wrap">
                    <label aria-required="true" for="ship_zip">Zip</label>
                    <input  class="form-control"  type="text" name="ship_zip" value="<?php echo $shopbiz['ship_zip']; ?>" placeholder="Zip code" >
                    </div>
                </div>

                <div class="form-group">
                    <div class="col-md-5 col-xs-12 label-wrap"><label aria-required="true" >Country</label></div>
                    <div class="col-md-7 col-xs-12 input-wrap">
                    	<select class="ss-select-small" style="width:100%; background-size:10px;" >
       ...
       <div class="row">
         <div class="text-center"><h3 style="padding-top:20px;"><strong>Contact Email</strong></h3></div>
         <div class="col-md-6">
			<div class="field-wrapper">
            <div class="form-group">
       ...
       <div class="row">
            ...
            <div class="field-wrapper">
                ...
                <div class="form-group">
    				<div class="col-md-10">
                    	<label aria-required="true" for="">Which other market places are selling. please provide Links to your store below: ( Click <i class="fa fa-plus-circle"></i> icon to add more sites, Click <i class="fa fa-minus-circle"></i> icon to remove stores )</label>
                    	<input class="form-control"  type="text" name="stores[]" value="<?php echo $stores[0]; ?>" placeholder="store link" >
  					</div>
  					<div class="col-md-2"><a href="javascript:;" onclick="addStores( this );" ><i class="fa fa-plus-circle fa-3x" style="margin-top: 15%;"></i></a></div>
                </div>
                <?php	for( $i=1; $i < count($stores); $i++ ) { ?>
                <div class="form-group">
    				<div class="col-md-10">
                    	<input class="form-control"  type="text" name="stores[]" value="<?php echo $stores[$i]; ?>" placeholder="store link" >
  					</div>
  					<div class="col-md-2">
                    <a href="javascript:;" onclick="$(this).closest(\'.form-group\').remove();" ><i class="fa fa-minus-circle fa-3x" ></i></a>
                    </div>
                </div>
                <?php } ?>
            </div>
...
function addStores( obj ) {
     var html = '<div class="form-group"><div class="col-md-10">';
     html += '<input class="form-control"  type="text" name="stores[]" value="" placeholder="store link" >';
  	 html += '</div>';
	 html += '<div class="col-md-2"><a href="javascript:;" onclick="$(this).closest(\'.form-group\').remove();" ><i class="fa fa-minus-circle fa-3x"></i></a></div>';
     html += '</div>';
	 
	 $(html).appendTo( $( obj).closest('.field-wrapper') );
