...
<div class="list_inner_fields">   
	<div class="sh_content">
		<div class="col-lg-12">
			...
			<h3><?php if($this->lang->line('prod_copy_listing') != '') { echo stripslashes($this->lang->line('prod_copy_listing')); } else echo 'Copy listing'; ?>
			
	<?php if($languagesList->num_rows() > 0 ) {?>
	<span style="float: right;margin: 0px 20px 0px 0px;">
	<input type="button" onclick="$('#sidenav').show();" value="<?php echo shopsy_lg('lg_add-lang','Add Language');?>" class="save_btn"/>
	</span>
	<?php }?>
	</h3>
...
<?php // end of multiple language update?>			
			...
			<div class="col-lg-12 sh_border" >
				...
				<div class="form-group">
					...
					<div class="col-sm-7 col-xs-12">
						<input type="text" name="product_name" style="width: 50%;" class="form-control" id="maxtextval" maxlength="140" onKeyUp="change('maxtextval','goo_item_title')"> 
					</div>
					<div class="col-md-3 col-sm-12 col-xs-12">
						<span class="list_div_note" ><?php if($this->lang->line('shop_maximum') != '') { echo stripslashes($this->lang->line('shop_maximum')); } else echo 'Maximum 140 characters'; ?>:</span>
						<span class="list_div_note" id="maxtext_notify">140</span>
...
<!-- 					<textarea onkeyup="change('desc','goo_item_desc');" class="form-control" name="description"  id="desc" rows="13"><?php echo $edit_item_detail->row()->description; ?></textarea> -->
			...
			<div class="col-lg-12 sh_border" data-pricing-type="Fixed">
				...
				<div class="form-group">
					...
					<div id="price_div_disp" class="col-sm-2">
						<input type="text" name="deal_time_to" id="deal_time_to" value="<?php if($edit_item_detail->row()->action=='DOD') { echo date('h:i A',strtotime($edit_item_detail->row()->deal_time_to)); } ?>" placeholder="<?php echo shopsy_lg('','To Time');?>" class="form-control time">
					</div>
