...
<div id="backgroundPopup"></div>
    ...
    <section class="container">
		...
		<ul class="bread_crumbs">
		   ...
		   <span>&rsaquo;</span>
		   <li><?php if($this->lang->line('Shop owner Info') != '') { echo stripslashes($this->lang->line('Shop owner Info')); } else echo 'Shop owner Info'; ?></li>
        </ul>
                ...
                <div class="community_page">            	
                  ...
                  <div class="community_right" style="margin: 0px; width: 98%;">
                        ...
                        <div class="split_prefile">
                            ...
                            <h2><?php if($this->lang->line('shop_publicprofile') != '') { echo stripslashes($this->lang->line('shop_publicprofile')); } else echo 'Create your public profile. Everything on this page can be seen by anyone'; ?>. </h2>
