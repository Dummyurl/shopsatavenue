		...
		<ul class="bread_crumbs">
		   ...
		   <li>Shop sections</li>
            ...
            <div style="margin: 20px 0;" class="manage-listing-heading">
                ...
                <?php if($this->lang->line('shop_createsections') != '') { echo stripslashes($this->lang->line('shop_createsections')); } else echo 'Create sections to help shoppers browse your shop'; ?>.

                <br>

                <?php if($this->lang->line('shop_sectionsappear') != '') { echo stripslashes($this->lang->line('shop_sectionsappear')); } else echo "Sections appear in your shop's left navigation"; ?>.
