            ...
            success: function(data) {
			  	...
			  	if(arr[0] == 'Success'){
					...
					for(var i=0; i < images.length-1; i++ ) {
					  $('#image_container').append('<div style="display:inline-block"><img class="upload-img1" src="" id="loadedImg" width="110px" ></img><div align="center"><a href="javascript:;" onclick="remove_image(\''+ images[i] +'\');">Remove</a></div></div>');
...
<div class="list_inner_fields" id="shop_page_seller">   
	...
	<div class="sh_content">
       <div style="margin: 0 0 0 20px">
		...
		<h3><?php echo $product_name; ?> (Draft)</h3>	
       </div>
        ...
        <form class="form-horizontal" method="post" action="" name="frm_product_media" id="frm_product_media" enctype="multipart/form-data">
            ...
            <div class="list_inner_right">
                <ul class="photo_list">
                    ...
                    ?>
                        <div style="display:inline-block">
                            <img class="upload-img1" src="/images/product/temp_img/<?php echo $val;?>" id="loadedImg" width="110px"  > </img>
                   ...
                   <p style="clear:both; line-height:normal">Minimum dimension: 225px x 225px<br />
              ...
              <div class="form-group" style="padding:10px 0px 0px 0">
                <input type="submit" name="submit" class="btn btn-info"  value="Previous Step"  />
                <input type="submit" name="submit" class="btn btn-info"  value="Next Step"  />
