...
<script type="text/javascript">
    ...
    $(document).ready(function(){
	    ...
	    $("#datefrom").datepicker({ dateFormat: "yy-mm-dd", changeMonth: true, changeYear: true,minDate:0   }).val()

		$("#dateto").datepicker({ dateFormat: "yy-mm-dd", changeMonth: true, changeYear: true,minDate:0   }).val()
...
<div class="shop_details">
    			...
    			<span class="shop_title">Edit Coupon</span>                
    ...
    <form method="post" action="site/shop/insertEditCouponcard">    	
		...
		<div class="list_div" style="border-radius:5px 5px 0 0; margin:5px 0 0">
            ...
            <div class="payment_check">
                ...
                <input type="hidden" name="sell_id" value="<?php echo $couponcard_details->row()->sell_id;?>" />

                <input type="hidden" name="price_type" value="<?php echo $couponcard_details->row()->price_type;?>" />
                ...
                <table class="coupon-code-table">
                	...
                	<tr>
                        ...
                        <td><input type="text" class="payment_txt" id="code" name="code" value="<?php echo $couponcard_details->row()->code;?>" readonly="readonly" /></td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="payment_txt" id="quantity" name="quantity" value="<?php echo $couponcard_details->row()->quantity;?>" /></td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="payment_txt" id="datefrom" name="datefrom" value="<?php echo $couponcard_details->row()->datefrom;?>" /></td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="payment_txt" id="dateto" name="dateto" value="<?php echo $couponcard_details->row()->dateto;?>" /></td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="payment_txt" id="price_value" value="<?php echo $couponcard_details->row()->price_value;?>" readonly/></td>
                    ...
                    <tr>
                        ...
                        <td><textarea class="payment_txt" name="description" id="description"><?php echo $couponcard_details->row()->description;?></textarea></td>
                    ...
                    <input type="radio" id="active" name="status" value="Active" <?php if($couponcard_details->row()->status=='Active'){ echo 'checked="checked"'; } ?>  />

                    	<label for="active" style="width:auto; margin:2px 0 0 0">Active</label>

                    <input type="radio" id="inactive" name="status" value="Inactive" <?php if($couponcard_details->row()->status=='Inactive'){ echo 'checked="checked"'; } ?>/>
                    ...
                    <input type="hidden" name="id" value="<?php echo $couponcard_details->row()->id;?>" />      
        ...
        <div class="payment_btn">
        	...
        	<input type="submit" class="btn_save_bill" value="Update Coupon" onclick="return couponcodeValidate();"/>
