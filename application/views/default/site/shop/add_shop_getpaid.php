...
<div class="shop_details">
    			...
    			<span class="shop_title"><?php if($this->lang->line('shop_methods') != '') { echo stripslashes($this->lang->line('shop_methods')); } else echo 'Payment methods you accept'; ?>.</span>                
