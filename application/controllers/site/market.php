...
class Market extends MY_Controller {
	...
	public function insertRegistry(){
			...
			$wedding_reg=addslashes(shopsy_lg('lg_wedding_reg','Your Wedding Registry Added Successfully'));
	...
	public function updateRegistry(){
		  if($this->checkLogin('U') != ''){    
			$this->product_model->update_details(REGISTRY,array('wedding_date' => $this->input->post('registryDate')),array('user_id' => $this->checkLogin('U')));
				$wedding_reg_updated=addslashes(shopsy_lg('lg_wedding_reg','Your Wedding Registry updated Successfully'));
	...
	public function deleteRegistry(){
		  if($this->checkLogin('U') != ''){ 
			...
			redirect('registry');
			$wedding_reg_deleted=addslashes(shopsy_lg('lg_wedding_reg','Your Wedding Registry Deleted Successfully'));
